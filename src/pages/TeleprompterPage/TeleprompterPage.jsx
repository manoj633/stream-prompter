...
function TeleprompterPage() {
  ...
  const [content, setContent] = useState(
    "sdfg<br />sdwsfgth<br />sadfgth<br />sadfg<br />sadfcgth<br />sadfgthyg<br />sadfgthyjg<br />sadfergtfhyjguh<br />asdfgthyjuhk<br />dsfgthgyjukhi<br />sadfrgthyjuhkil<br />sadfgthyjuhkil<br />asfedgrfthyjuhkio<br />adsfedgrfthjgyuhkilo<br />dsfedgrfhtgyjukhil<br />dsfgrhtyjgukhilo"
  );
  ...
  useEffect(() => {
    ...
    document.documentElement.style.setProperty("--align", alignment);
  ...
  return (
    <div className="App">
      ...
      <div
        className={`content ${isFlipX ? "flipx" : ""} ${
          isFlipY ? "flipy" : ""
        }`}
        ref={contentRef}
        spellCheck="false"
      ...
      <div
        ...
        className={`${isFlipX ? "shiftx" : ""} ${isFlipY ? "shifty" : ""}`}
      ></div>
    </div>
  );
}
